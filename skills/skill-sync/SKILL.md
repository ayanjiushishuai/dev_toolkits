---
name: skill-sync
description: "同步本地 skills 到 Git 仓库并发布。当用户说"同步skills"、"发布skills"、"更新skills到github"、"sync skills"时触发。本 skill 负责将 ~/.claude/skills/ 下的所有 skills 同步到 dev_toolkits 仓库，并打包 .skill 文件发布 Release。"
---
...
**任务：** 检查 `~/.claude/skills/` 下有哪些 skills
